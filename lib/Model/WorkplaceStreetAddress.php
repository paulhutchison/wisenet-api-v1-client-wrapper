...
/**
 * WorkplaceStreetAddress Class Doc Comment
 *
 * @category Class
 * @package  Phwebs\Wisenet
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WorkplaceStreetAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WorkplaceStreetAddress';
...
'country_id' => 'getCountryId'    ];
     ...
     * Sets building_name
     *
     * @param string $building_name Building Name of the Workplace Street Address
     *
     * @return $this
     */
     ...
     * Sets unit_details
     *
     * @param string $unit_details Unit Details of the Workplace Street Address
     *
     * @return $this
     */
     ...
     * Sets street_number
     *
     * @param string $street_number Street Number of the Workplace Street Address
     *
     * @return $this
     */
     ...
     * Sets street_name
     *
     * @param string $street_name Street Name of the Workplace Street Address
     *
     * @return $this
     */
     ...
     * Sets address_line1
     *
     * @param string $address_line1 Address Line of the Workplace Street Address
     *
     * @return $this
     */
     ...
     *
     * @param string $extra_address_line Additional address details of the Workplace Street Address
     *
     * @return $this
     */
     ...
     * Sets suburb
     *
     * @param string $suburb Suburb of the Workplace Street Address
     *
     * @return $this
     */
     ...
     * Sets state_id
     *
     * @param string $state_id See combo States. State of the Workplace Street Address
     *
     * @return $this
     */
     ...
     * Sets postcode
     *
     * @param string $postcode Postcode of the Workplace Street Address
     *
     * @return $this
     */
     ...
     * Sets country_id
     *
     * @param int $country_id See combo Countries. Country of the Workplace Street Address
     *
     * @return $this
     */
