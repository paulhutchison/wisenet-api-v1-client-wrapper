...
/**
 * CommencedAtSchoolFlag Class Doc Comment
 *
 * @category Class
 * @package  Phwebs\Wisenet
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommencedAtSchoolFlag implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommencedAtSchoolFlag';
    ...
    protected static $swaggerTypes = [
        'commenced_at_school_flag_id' => 'int',
'code' => 'string',
'description' => 'string'    ];
...
'description' => 'getDescription'    ];
     ...
     *
     * @param int $commenced_at_school_flag_id commenced_at_school_flag_id
     *
     * @return $this
     */
