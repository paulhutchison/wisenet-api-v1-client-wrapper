...
/**
 * LearnerSgPersonalPermanentAddress Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LearnerSgPersonalPermanentAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LearnerSgPersonalPermanentAddress';
...
'permanent_address' => 'getPermanentAddress'    ];
     ...
     * Sets building_name
     *
     * @param string $building_name Building name of learner's permanent address
     *
     * @return $this
     */
     ...
     * Sets po_box
     *
     * @param string $po_box PO Box number of learner's permanent address
     *
     * @return $this
     */
     ...
     * Sets unit_details
     *
     * @param string $unit_details Unit details of learner's permanent address
     *
     * @return $this
     */
     ...
     * Sets street_number
     *
     * @param string $street_number Street number of learner's permanent address
     *
     * @return $this
     */
     ...
     * Sets street_name
     *
     * @param string $street_name Street name of learner's permanent address
     *
     * @return $this
     */
     ...
     *
     * @param string $extra_address_line Suburb/Town of learner's permanent address
     *
     * @return $this
     */
     ...
     *
     * @param string $suburb_town_city City/Region of learner's permanent address
     *
     * @return $this
     */
     ...
     * Sets postcode
     *
     * @param string $postcode Postcode of learner's permanent address
     *
     * @return $this
     */
     ...
     * Sets country_id
     *
     * @param int $country_id See combo NzCountries
     *
     * @return $this
     */
     ...
     *
     * @param string $permanent_address Read only. Address Line1 of learner's permanent address
     *
     * @return $this
     */
