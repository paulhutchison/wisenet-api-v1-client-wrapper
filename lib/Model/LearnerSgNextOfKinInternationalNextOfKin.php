...
/**
 * LearnerSgNextOfKinInternationalNextOfKin Class Doc Comment
 *
 * @category Class
 * @package  Phwebs\Wisenet
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LearnerSgNextOfKinInternationalNextOfKin implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LearnerSgNextOfKinInternationalNextOfKin';
...
'middle_name' => 'string',
'last_name' => 'string',
'address' => '\Phwebs\Wisenet\Model\LearnerSgNextOfKinInternationalNextOfKinAddress',
'phone_home' => 'string',
'phone_work' => 'string',
'mobile' => 'string',
'email' => 'string'    ];
...
'email' => 'getEmail'    ];
     ...
     * Sets first_name
     *
     * @param string $first_name First Name of international next of kin
     *
     * @return $this
     */
     ...
     * Sets middle_name
     *
     * @param string $middle_name Middle Name of international next of kin
     *
     * @return $this
     */
     ...
     * Sets last_name
     *
     * @param string $last_name Last Name of international next of kin
     *
     * @return $this
     */
     ...
     * Gets address
     *
     * @return \Phwebs\Wisenet\Model\LearnerSgNextOfKinInternationalNextOfKinAddress
     */
     ...
     * Sets address
     *
     * @param \Phwebs\Wisenet\Model\LearnerSgNextOfKinInternationalNextOfKinAddress $address address
     *
     * @return $this
     */
     ...
     * Sets phone_home
     *
     * @param string $phone_home Home Number of international next of kin
     *
     * @return $this
     */
     ...
     * Sets phone_work
     *
     * @param string $phone_work Work Number of international next of kin
     *
     * @return $this
     */
     ...
     * Sets mobile
     *
     * @param string $mobile Mobile Number of international next of kin. Accepts numbers only. International format is preferable eg. +614xxxxxxxxx\".
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string $email Email Address of international next of kin
     *
     * @return $this
     */
