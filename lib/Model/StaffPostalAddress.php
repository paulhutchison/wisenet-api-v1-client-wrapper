...
/**
 * StaffPostalAddress Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StaffPostalAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StaffPostalAddress';
...
'country_id' => 'getCountryId'    ];
     ...
     * Sets address_line1
     *
     * @param string $address_line1 Address Line 1 of the Staff Postal Address
     *
     * @return $this
     */
     ...
     *
     * @param string $extra_address_line Additional address details of the Staff Postal Address
     *
     * @return $this
     */
     ...
     * Sets suburb
     *
     * @param string $suburb Suburb of the Staff Postal Address
     *
     * @return $this
     */
     ...
     * Sets postcode
     *
     * @param string $postcode Postcode of the Staff Postal Address
     *
     * @return $this
     */
     ...
     * Sets state_id
     *
     * @param int $state_id Australia only. State of the Staff Postal Address. See States
     *
     * @return $this
     */
     ...
     * Sets country_id
     *
     * @param int $country_id Country of the Staff Postal Address. See Countries
     *
     * @return $this
     */
