...
/**
 * AvStudyReason Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AvStudyReason implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AvStudyReason';
...
'delimiters' => 'getDelimiters'    ];
     ...
     *
     * @param int $av_study_reason_id av_study_reason_id
     *
     * @return $this
     */
