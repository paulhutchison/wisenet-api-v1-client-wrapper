...
'last_modified_time_stamp' => 'getLastModifiedTimeStamp'    ];
    ...
    {
        $this->container['audit_log_id'] = isset($data['audit_log_id']) ? $data['audit_log_id'] : null;
        ...
        $this->container['audit_action'] = isset($data['audit_action']) ? $data['audit_action'] : null;
     ...
     * Sets audit_log_id
     *
     * @param int $audit_log_id Primary Id of the Audit Log that is auto generated
     *
     * @return $this
     */
     ...
     * Sets record_id
     *
     * @param int $record_id Id of the record Audit Log entry is for
     *
     * @return $this
     */
     ...
     * Sets entity_name
     *
     * @param string $entity_name Name of entity the Audit Log entry is for. See entities Entity for list of values
     *
     * @return $this
     */
    ...
    {
        return $this->container['audit_action'];
    }

    /**
     * Sets audit_action
     *
     * @param string $audit_action Audit action of the Audit Log entry. I is for insert, U for update and D for delete.
     *
     * @return $this
     */
    public function setAuditAction($audit_action)
    {
        $this->container['audit_action'] = $audit_action;
     ...
     *
     * @param \DateTime $last_modified_time_stamp Date when the Audit Log entry was created
     *
     * @return $this
     */
