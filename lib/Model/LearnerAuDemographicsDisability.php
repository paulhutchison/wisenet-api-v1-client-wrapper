...
/**
 * LearnerAuDemographicsDisability Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LearnerAuDemographicsDisability implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LearnerAuDemographicsDisability';
...
'effective_to_date' => 'getEffectiveToDate'    ];
    ...
    {
        $this->container['disability_id'] = isset($data['disability_id']) ? $data['disability_id'] : null;
    ...
    {
        return $this->container['disability_id'];
    }

    /**
     * Sets disability_id
     *
     * @param int $disability_id See combo Disabilities
     *
     * @return $this
     */
    public function setDisabilityId($disability_id)
    {
        $this->container['disability_id'] = $disability_id;
     ...
     *
     * @param \DateTime $effective_from_date Date Disability is effective from
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $effective_to_date Date Disability is effective to
     *
     * @return $this
     */
