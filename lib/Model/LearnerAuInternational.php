...
/**
 * LearnerAuInternational Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LearnerAuInternational implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LearnerAuInternational';
...
'nationality_id' => 'int',
'address' => '\Phwebs\Wisenet\Model\LearnerAuInternationalAddress',
'phone_home' => 'string',
'phone_work' => 'string'    ];
...
'phone_work' => 'getPhoneWork'    ];
     ...
     * Sets visa_type_id
     *
     * @param int $visa_type_id See combo VisaTypes
     *
     * @return $this
     */
     ...
     * Sets nationality_id
     *
     * @param int $nationality_id See combo Countries
     *
     * @return $this
     */
     ...
     * Gets address
     *
     * @return \Phwebs\Wisenet\Model\LearnerAuInternationalAddress
     */
     ...
     * Sets address
     *
     * @param \Phwebs\Wisenet\Model\LearnerAuInternationalAddress $address address
     *
     * @return $this
     */
