...
/**
 * WorkplacePostalAddress Class Doc Comment
 *
 * @category Class
 * @package  Phwebs\Wisenet
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WorkplacePostalAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WorkplacePostalAddress';
...
'country_id' => 'getCountryId'    ];
     ...
     * Sets building_name
     *
     * @param string $building_name Building Name of the Workplace Postal Address
     *
     * @return $this
     */
     ...
     * Sets po_box
     *
     * @param string $po_box PO Box Number of the Workplace Postal Address
     *
     * @return $this
     */
     ...
     * Sets unit_details
     *
     * @param string $unit_details Unit Details of the Workplace Postal Address
     *
     * @return $this
     */
     ...
     * Sets street_number
     *
     * @param string $street_number Street Number of the Workplace Postal Address
     *
     * @return $this
     */
     ...
     * Sets street_name
     *
     * @param string $street_name Street Name of the Workplace Postal Address
     *
     * @return $this
     */
     ...
     * Sets address_line1
     *
     * @param string $address_line1 Address Line of the Workplace Postal Address
     *
     * @return $this
     */
     ...
     *
     * @param string $extra_address_line Additional address details of the Workplace Postal Address
     *
     * @return $this
     */
     ...
     *
     * @param string $suburb_town_city Suburb of the Workplace Postal Address
     *
     * @return $this
     */
     ...
     * Sets state_id
     *
     * @param string $state_id See combo States. State of the Workplace Postal Address
     *
     * @return $this
     */
     ...
     * Sets postcode
     *
     * @param string $postcode Postcode of the Workplace Postal Address
     *
     * @return $this
     */
     ...
     * Sets country_id
     *
     * @param int $country_id See combo Countries. Country of the Workplace Postal Address
     *
     * @return $this
     */
