...
/**
 * StaffStreetAddress Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StaffStreetAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StaffStreetAddress';
...
'country_id' => 'getCountryId'    ];
     ...
     * Sets address_line1
     *
     * @param string $address_line1 Address Line 1 of the Staff Street Address
     *
     * @return $this
     */
     ...
     *
     * @param string $extra_address_line Additional address details of the Staff Street Address
     *
     * @return $this
     */
     ...
     * Sets suburb
     *
     * @param string $suburb Suburb of the Staff Street Address
     *
     * @return $this
     */
     ...
     * Sets postcode
     *
     * @param string $postcode Postcode of the Staff Street Address
     *
     * @return $this
     */
     ...
     * Sets state_id
     *
     * @param int $state_id Australia only. State of the Staff Street Address. See States
     *
     * @return $this
     */
     ...
     * Sets country_id
     *
     * @param int $country_id Country of the Staff Street Address. See Countries
     *
     * @return $this
     */
