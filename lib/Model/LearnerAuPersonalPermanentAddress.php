...
/**
 * LearnerAuPersonalPermanentAddress Class Doc Comment
 *
 * @category Class
 * @package  Phwebs\Wisenet
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LearnerAuPersonalPermanentAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LearnerAuPersonalPermanentAddress';
...
'permanent_address' => 'getPermanentAddress'    ];
     ...
     *
     * @param string $extra_address_line Additional address details of learner's permanent address
     *
     * @return $this
     */
     ...
     *
     * @param string $suburb_town_city Suburb of learner's permanent address
     *
     * @return $this
     */
