...
/**
 * LearnerNzPersonalEmailAddresses Class Doc Comment
 *
 * @category Class
 * @package  Phwebs\Wisenet
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LearnerNzPersonalEmailAddresses implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LearnerNzPersonalEmailAddresses';
...
'alternative_email' => 'getAlternativeEmail'    ];
     ...
     * Sets email
     *
     * @param string $email Email address of the learner
     *
     * @return $this
     */
     ...
     *
     * @param string $alternative_email Alternative email address of the learner
     *
     * @return $this
     */
