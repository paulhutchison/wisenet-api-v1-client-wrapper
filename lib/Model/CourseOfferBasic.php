...
/**
 * CourseOfferBasic Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CourseOfferBasic implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CourseOfferBasic';
...
'course_offer_end_date' => 'getCourseOfferEndDate'    ];
     ...
     *
     * @param \DateTime $course_offer_start_date course_offer_start_date
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $course_offer_end_date course_offer_end_date
     *
     * @return $this
     */
