...
/**
 * LearnerAuDemographicsCitizenship Class Doc Comment
 *
 * @category Class
 * @package  Phwebs\Wisenet
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LearnerAuDemographicsCitizenship implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LearnerAuDemographicsCitizenship';
...
'effective_from_date' => 'getEffectiveFromDate'    ];
     ...
     *
     * @param int $citizen_resident_id See combo FhCitizenResident
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $effective_from_date Date Citizenship is effective from
     *
     * @return $this
     */
