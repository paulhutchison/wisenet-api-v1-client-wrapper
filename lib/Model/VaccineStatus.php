...
/**
 * VaccineStatus Class Doc Comment
 *
 * @category Class
 * @package  Phwebs\Wisenet
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VaccineStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VaccineStatus';
...
'is_active' => 'getIsActive'    ];
     ...
     * Sets description
     *
     * @param string $description Vaccine status description
     *
     * @return $this
     */
     ...
     * Sets is_active
     *
     * @param bool $is_active Whether vaccine status is active
     *
     * @return $this
     */
